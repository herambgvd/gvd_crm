...
import { fetchTeamAttendance, exportAttendance } from "../api";
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => exportAttendance({ scope: "team", ...params })}
          >
        ...
        <div>
          <h1 className="text-xl font-semibold tracking-tight">Team Attendance</h1>
          <p className="text-sm text-muted-foreground">View attendance records for your team members</p>
        </div>
